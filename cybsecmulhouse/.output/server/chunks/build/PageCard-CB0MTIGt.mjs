...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-black" }, _attrs))}><div class="isolate shadow-md rounded-md overflow-hidden bg-black py-24 sm:py-32 mx-12 my-4"><img${ssrRenderAttr("src", _imports_0)} alt="" class="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center"><div class="absolute top-10 right-10 h-16 w-16 text-white ..."><button>fr</button> | <button>en</button></div><div class="w-full text-8xl text-center text-white"><img${ssrRenderAttr("src", _imports_1)} class="mx-auto object-contain object-center w-1/4 brightness-50 hover:brightness-200 hover:duration-150">`);
      ...
      _push(`<br></p></div><div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none"><div class="grid grid-cols-1 gap-x-8 gap-y-6 text-xl font-normal leading-7 text-slate-400 sm:grid-cols-2 md:flex lg:gap-x-10">`);
...
//# sourceMappingURL=PageCard-CB0MTIGt.mjs.map
