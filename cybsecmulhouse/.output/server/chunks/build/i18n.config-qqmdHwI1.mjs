const i18n_config = () => ({
  ...
  messages: {
    ...
    fr: {
      welcome: "Bienvenue",
      subtitle_m: "",
      //'Un capture the flag dans une ambiance détendue !',
      register_m: "S'enregistrer",
      name_m: "Nom",
      forename_m: "Pr\xE9nom",
      uni_m: "Universit\xE9",
      challenge_m: "Combien vaut 10!>>7 en \xE9criture hexad\xE9cimale ?",
...
//# sourceMappingURL=i18n.config-qqmdHwI1.mjs.map
