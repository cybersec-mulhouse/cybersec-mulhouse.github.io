...
import { $ as $fetch, m as klona, n as defu, o as sanitizeStatusCode, p as defuFn, q as createHooks, r as createError$1, t as toRouteMatcher, v as createRouter$1, w as getRequestHeader, x as getRequestHeaders, y as destr, z as isEqual$1, A as setCookie, B as getCookie, C as deleteCookie } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./coc-CbMB80NS.mjs').then((m) => m.default || m)
  },
  {
    name: "coc___fr",
    path: "/coc",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CPMzghTb.mjs').then((m) => m.default || m)
  },
  {
    name: "index___fr",
    path: "/",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./register-Cux6Ih2O.mjs').then((m) => m.default || m)
  },
  {
    name: "register___fr",
    path: "/register",
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-CllxnwvF.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-BleOkLpd.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BeuwG-oG.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useI18n as a, useLocalePath as b, useSeoMeta as c, __nuxt_component_0$1 as d, entry$1 as default, useRouter as e, parseQuery as f, useRuntimeConfig as g, hasProtocol as h, navigateTo as i, joinURL as j, withoutTrailingSlash as k, useAppConfig as l, useState as m, nuxtLinkDefaults as n, useNuxtApp as o, parseURL as p, useHead as u, withTrailingSlash as w };
