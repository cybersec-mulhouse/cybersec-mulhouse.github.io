import { version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, defineComponent, h, inject, onUnmounted, toRef, isRef, provide, createElementBlock, computed, unref, shallowReactive, Suspense, nextTick, Transition, hasInjectionContext, Fragment, mergeProps, useSSRContext, createApp, effectScope, reactive, shallowRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, isReadonly, Text, withCtx, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, l as klona, m as defu, n as sanitizeStatusCode, o as defuFn, p as createHooks, h as createError$1, t as toRouteMatcher, q as createRouter$1, r as parse$1, v as getRequestHeader, w as getRequestHeaders, x as destr, y as isEqual$1, z as setCookie, A as getCookie, B as deleteCookie } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./coc-Ci6qKs2s.mjs').then((m) => m.default || m)
  },
  {
    name: "coc___fr",
    path: "/coc",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BqGtuGLo.mjs').then((m) => m.default || m)
  },
  {
    name: "index___fr",
    path: "/",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./register-C3FXwPPM.mjs').then((m) => m.default || m)
  },
  {
    name: "register___fr",
    path: "/register",
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-2j__G63d.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-B7Ggf_KN.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-VCAjZ4Bi.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-DZt8Merf.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useI18n as a, __nuxt_component_0$1 as b, useLocalePath as c, useRouter as d, entry$1 as default, parseQuery as e, useRuntimeConfig as f, navigateTo as g, hasProtocol as h, withoutTrailingSlash as i, joinURL as j, useAppConfig as k, useState as l, useNuxtApp as m, nuxtLinkDefaults as n, parseURL as p, useHead as u, withTrailingSlash as w };
